...
const savePin = (id)=> {
    if(!alreadySaved){
     ...
     .commit()// study this what is promise and why we can use .then on promise
     .then(()=>{
  ...
  <img className="rounded-lg w-full" alt="user-post" src={urlFor(image).width(250).url()} />
    {postHovered && (
<div className="absolute top-0 w-full h-full flez flez-col justify-between p-1 pr-2 pb-2 z-50">
